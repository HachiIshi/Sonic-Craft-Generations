package net.mcreator.soniccraftgenerations;
...
@Mod("sonic_craft_generations")
public class SonicCraftGenerationsMod {
	public static final Logger LOGGER = LogManager.getLogger(SonicCraftGenerationsMod.class);
	public static final String MODID = "sonic_craft_generations";

	public SonicCraftGenerationsMod() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		SonicCraftGenerationsModItems.REGISTRY.register(bus);
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									SonicCraftGenerationsMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			SonicCraftGenerationsMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}
