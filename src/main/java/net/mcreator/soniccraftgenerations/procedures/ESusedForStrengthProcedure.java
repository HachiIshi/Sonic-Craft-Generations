...
public class ESusedForStrengthProcedure {
	public static void execute(Entity entity) {
		...
		if ((entity.getCapability(SonicCraftGenerationsModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new SonicCraftGenerationsModVariables.PlayerVariables())).ChaosDrive >= 1) {
			((LivingEntity) entity).getAttribute(SonicCraftGenerationsModAttributes.STRENGTH.get()).setBaseValue((((LivingEntity) entity).getAttribute(SonicCraftGenerationsModAttributes.STRENGTH.get()).getValue() + 1));
			{
